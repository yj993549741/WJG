...
namespace WindowsTest
{
    public partial class winMain : MainForm
    {
        public winMain()
        {
            ...
            this.txTreeComboBox1.DataSource = TestData.GetTreeData(3);
            this.txTreeComboBox1.MultiLevelDataSourceMember = "Depts";
        ...
        private void txButton10_Click(object sender, EventArgs e)
        {
